...
// netlify/functions/getSongsByArtist copy.js
var getSongsByArtist_copy_exports = {};
__export(getSongsByArtist_copy_exports, {
  handler: () => handler
});
...
module.exports = __toCommonJS(getSongsByArtist_copy_exports);
// Annotate the CommonJS export names for ESM import in node:
0 && (module.exports = {
  handler
});
//# sourceMappingURL=getSongsByArtist copy.js.map
